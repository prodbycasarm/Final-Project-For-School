    ...
    <div>
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_num'])) {
            ...
            if ($stmt->execute()) {
                ...
                header("Location: page_admin.php?message=Rapport supprimé avec succès.");
                exit;
            } else {
        ...
        $classer = isset($_POST['classer']) ? $_POST['classer'] : 'numetu';
        ...
        // Requête pour récupérer les informations des rapports avec jointure
        $sql = "SELECT 
                    acces_etu.nomsup,
                    acces_etu.NomEtu,
                    acces_etu.numetu,
        ...
        <div class="tableau">
            ...
            <?php if (!empty($_SESSION['supri'])): ?>
                <p class="tous" style="color: <?php echo (strpos($_SESSION['supri'], 'succès') !== false) ? 'green' : 'red'; ?>;">
                    <?php echo $_SESSION['supri']; ?>
                </p>
                <?php unset($_SESSION['supri']); // Clear the message after displaying it ?>
            <?php endif; ?>
            ...
            <form class="tous" method="POST" action="">
                Classer par 
                <select name="classer">
                    <option value="numetu" <?php echo ($classer == 'numetu') ? 'selected' : ''; ?>>Numéro d'étudiant</option>
                    <option value="NomEtu" <?php echo ($classer == 'NomEtu') ? 'selected' : ''; ?>>Étudiant</option>
            ...
            <table class="tous" style="border-collapse: collapse; width: 70%;">
                <tr>
                    ...
                    <th style="border: 1px solid black; padding: 8px;">Étudiant</th>
                    <th style="border: 1px solid black; padding: 8px;">Superviseur</th>
                    <th style="border: 1px solid black; padding: 8px;">Employeur</th>
                    <th style="border: 1px solid black; padding: 8px; text-align: center;">Analyse de stages</th>
                    <th style="border: 1px solid black; padding: 8px; text-align: center;">Évaluation d'entreprise</th>
                    <th style="border: 1px solid black; padding: 8px; text-align: center;">Grille d'évaluation</th>
                </tr>
                <?php
                // Itérer à travers le jeu de résultats
                while ($row = mysqli_fetch_assoc($result)) {
                    $lien_vers_analyse_de_stage = "experiences/" . htmlspecialchars($row['numetu']) . ".html";
                    $lien_vers_evaluation_entreprises = "evaluations/entreprises/" . htmlspecialchars($row['numetu']) . ".html";
                    $lien_vers_grille_evaluation = "evaluations/stagiaires/" . htmlspecialchars($row['numetu']) . ".html";
                    
                    ?>
                    <tr>
                        <td style="border: 1px solid black; padding: 8px; text-align: center;"><?php echo htmlspecialchars($row['numetu']); ?></td>
                ...
                <!-- Boutons pour ANALYSE DE STAGES-->
                        <div style="display: flex; align-items: center; gap: 10px;">
                            <?php if (file_exists($lien_vers_analyse_de_stage)) { ?>
                                <a href="<?php echo $lien_vers_analyse_de_stage; ?>" title="Voir l'analyse de stage">
                                    <img src="img/voir.png" width="20" height="20" alt="Voir le rapport" style="vertical-align: middle;">
                                </a>
                            <?php } ?>

                            <?php if (file_exists($lien_vers_analyse_de_stage)) { ?>
                                <form action="supprimer_documents.php" method="post" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer l\'analyse de stage ?');" style="margin: 0;">
                                    <input type="hidden" name="fichier" value="<?php echo htmlspecialchars($lien_vers_analyse_de_stage); ?>">
                ...
                <!-- Boutons pour évaluation d'entreprise-->                        
                        <td style="border: 1px solid black; padding: 8px; text-align: center;">
                            
                        
                        <div style="display: flex; align-items: center; gap: 10px;">
                            <?php if (file_exists($lien_vers_evaluation_entreprises)) { ?>
                                <a href="<?php echo $lien_vers_evaluation_entreprises; ?>" title="Voir l'analyse de stage">
                                    <img src="img/voir.png" width="20" height="20" alt="Voir le rapport" style="vertical-align: middle;">
                                </a>
                            <?php } ?>
                            ...
                            <?php if (file_exists($lien_vers_evaluation_entreprises)) { ?>
                                <form action="supprimer_documents.php" method="post" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer l\'analyse de stage ?');" style="margin: 0;">
                                    <input type="hidden" name="fichier" value="<?php echo htmlspecialchars($lien_vers_evaluation_entreprises); ?>">
                                    <button type="submit" style="background: none; border: none; padding: 0;">
                                        <img src="img/supprimer.png" width="20" height="20" alt="Supprimer le rapport" style="vertical-align: middle;">
                                    </button>
                                </form>
                ...
                <!-- Boutons pour Grille d'évaluation-->                    
                        <td style="border: 1px solid black; padding: 8px; text-align: center;">
                            
                        
                        <div style="display: flex; align-items: center; gap: 10px;">
                            <?php if (file_exists($lien_vers_grille_evaluation)) { ?>
                                <a href="<?php echo $lien_vers_grille_evaluation; ?>" title="Voir l'analyse de stage">
                                    <img src="img/voir.png" width="20" height="20" alt="Voir le rapport" style="vertical-align: middle;">
                                </a>
                            <?php } ?>
                            ...
                            <?php if (file_exists($lien_vers_grille_evaluation)) { ?>
                                <form action="supprimer_documents.php" method="post" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer l\'analyse de stage ?');" style="margin: 0;">
                                    <input type="hidden" name="fichier" value="<?php echo htmlspecialchars($lien_vers_grille_evaluation); ?>">
                                    <button type="submit" style="background: none; border: none; padding: 0;">
                                        <img src="img/supprimer.png" width="20" height="20" alt="Supprimer le rapport" style="vertical-align: middle;">
                                    </button>
                                </form>
